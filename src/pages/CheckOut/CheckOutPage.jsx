    ...
    <div>
      <div id="ch-firstDiv">
        ...
        <div className="ch-firstDiv-2">
          <p>
            How do you like our checkout?<a href="#">Give us feedback</a>
          </p>
        </div>
      </div>
      <div id="ch-secDiv">
        <div className="ch-secDiv-1">
          ...
          <div className="ch-secDiv-1-2">
            ...
            <div id="ch-checkbox">
              <input type="checkbox" /> <label>Save as primary address</label>
            </div>
            <div id="add-button">
        ...
        <div className="ch-secDiv-2">
          ...
          <div className="ch-secDiv-2-2">
            <p>
              By placing your order, you agree to eBay's <br />
              <a href="#">User Agreement</a> and <a href="#">Privacy Notice.</a>
            </p>
          </div>
          <div id="googlePay">
            <GooglePayButton
